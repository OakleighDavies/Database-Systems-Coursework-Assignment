        ...
        <section>
            ...
            <div class="d-flex justify-content-center">
                <div class='btn-group dropend'>
                    ...
                    <button type="button" onclick="window.location.href='https://teach.cs.keele.ac.uk/users/REDACTED/databaseSystems/updatingTables.php';" class="btn btn-dark ps-3 pe-3 ms-3 me-3 rounded-2">Table Updating Mode</button>
                </div>
                <?php
